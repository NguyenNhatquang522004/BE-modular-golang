...
type ILiveSessionRepository interface {
	...
	CreateBulkLiveSessions(ctx context.Context, liveSessions []*entity.LiveSession) (int64, []*dto.BulkError, error)
	...
	UpdateBulkLiveSessions(ctx context.Context, liveSessions []*entity.LiveSession) (int64, []*dto.BulkError, error)
	DeleteLiveSession(ctx context.Context, id string) error
	DeleteBulkLiveSessions(ctx context.Context, ids []string) (int64, []*dto.BulkError, error)
