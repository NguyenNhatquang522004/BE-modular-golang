...
type IAlbumsRepository interface {
	...
	CreateBulkAlbums(ctx context.Context, albums []*entity.Album) (int64, []*dto.BulkError, error)
	...
	UpdateBulkAlbums(ctx context.Context, albums []*entity.Album) (int64, []*dto.BulkError, error)
	DeleteAlbum(ctx context.Context, id string) error
	DeleteBulkAlbums(ctx context.Context, ids []string) (int64, []*dto.BulkError, error)
}
