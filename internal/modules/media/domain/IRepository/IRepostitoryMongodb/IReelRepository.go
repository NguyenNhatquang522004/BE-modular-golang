...
type IReelRepository interface {
	...
	CreateBulkReels(ctx context.Context, reels []*entity.Reel) (int64, []*dto.BulkError, error)
	...
	UpdateBulkReels(ctx context.Context, reels []*entity.Reel) (int64, []*dto.BulkError, error)
	DeleteReel(ctx context.Context, id string) error
	DeleteBulkReels(ctx context.Context, ids []string) (int64, []*dto.BulkError, error)
}
