...
type IPostMediaRepository interface {
	...
	CreateBulkPostMedia(ctx context.Context, postMedias []*entity.PostMedia) (int64, []*dto.BulkError, error)
	...
	UpdateBulkPostMedia(ctx context.Context, postMedias []*entity.PostMedia) (int64, []*dto.BulkError, error)
