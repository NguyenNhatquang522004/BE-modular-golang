...
type IPostExtensionRepository interface {
	...
	CreateBulkPostExtension(ctx context.Context, postExtensions []*entity.PostExtension) (int64, []*dto.BulkError, error)
	...
	UpdateBulkPostExtension(ctx context.Context, postExtensions []*entity.PostExtension) (int64, []*dto.BulkError, error)
	DeleteByPostID(ctx context.Context, postID string) error
	DeleteBulkByPostIDs(ctx context.Context, postIDs []string) (int64, []*dto.BulkError, error)
