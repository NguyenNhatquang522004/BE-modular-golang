...
type IPostSettingRepository interface {
	...
	UpdateBulkPostSettings(ctx context.Context, postSettings []*entity.PostSetting) (int64, []*mongodbErrors.BulkError, error)
	DeletePostSetting(ctx context.Context, Postid string) error
	DeleteBulkPostSettings(ctx context.Context, Postids []string) (int64, []*mongodbErrors.BulkError, error)
