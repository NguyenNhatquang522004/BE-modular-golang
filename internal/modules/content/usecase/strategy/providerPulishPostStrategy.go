...
func NewPublishDeleteStrategy(h1 *PostExtensionStrategy, h2 *PostInsightStrategy, h3 *MediaStrategy, h4 *SettingStrategy, h5 *PostInsightStrategy) []IStrategy.IPublishDeleteStrategy {
	return []IStrategy.IPublishDeleteStrategy{h1, h2, h3, h4, h5}
}
