...
func NewAddGroupParticipantUsecase(conversationRepo IRepositoryMongodb.IConversationsRepository, conversationParticipantRepo IRepositoryMongodb.IConversationParticipantsRepository) *AddGroupParticipantUsecase {
	return &AddGroupParticipantUsecase{
		conversationRepo:            conversationRepo,
		conversationParticipantRepo: conversationParticipantRepo,
	}
}
func (u *AddGroupParticipantUsecase) Execute(ctx context.Context, req *req.AddGroupParticipantRequest) (*res.FailedParticipantResponse, error) {
