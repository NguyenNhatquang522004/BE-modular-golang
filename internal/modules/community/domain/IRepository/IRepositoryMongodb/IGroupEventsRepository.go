...
type IGroupEventsRepository interface {
	...
	CreateBulkGroupEvents(ctx context.Context, events []*entity.GroupEvent) (int64, []*mongodbErrors.BulkError, error)
	...
	UpdateBulkGroupEvents(ctx context.Context, events []*entity.GroupEvent) (int64, []*mongodbErrors.BulkError, error)
	...
	DeleteBulkGroupEvents(ctx context.Context, ids []string) (int64, []*mongodbErrors.BulkError, error)
