...
type IGroupjoinQuestionsRepository interface {
	...
	CreateBulkGroupJoinQuestions(ctx context.Context, questions []entity.GroupJoinQuestion) (int64, []*mongodbErrors.BulkError, error)
	...
	UpdateBulkGroupJoinQuestions(ctx context.Context, questions []entity.GroupJoinQuestion) (int64, []*mongodbErrors.BulkError, error)
	DeleteGroupJoinQuestion(ctx context.Context, questionID string) error
	DeleteBulkGroupJoinQuestions(ctx context.Context, questionIDs []string) (int64, []*mongodbErrors.BulkError, error)
	DeleteGroupJoinQuestionsByGroupID(ctx context.Context, groupID string) (int64, error)
	DeleteBulkGroupJoinQuestionsByGroupID(ctx context.Context, groupIDs []string) (int64, []*mongodbErrors.BulkError, error)
	DeleteGroupJoinQuestionByIDAndGroupID(ctx context.Context, questionID string, groupID string) error
	DeleteBulkGroupJoinQuestionByIDAndGroupID(ctx context.Context, questionIDs []string, groupID string) (int64, []*mongodbErrors.BulkError, error)
}
