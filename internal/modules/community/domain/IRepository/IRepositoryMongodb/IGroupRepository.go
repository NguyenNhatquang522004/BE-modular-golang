...
type IGroupRepository interface {
	...
	CreateBulkGroups(ctx context.Context, groups []*entity.Group) (int64, []*dto.BulkError, error)
	...
	UpdateBulkGroups(ctx context.Context, groups []*entity.Group) (int64, []*dto.BulkError, error)
	DeleteGroup(ctx context.Context, id string) error
	DeleteBulkGroups(ctx context.Context, ids []string) (int64, []*dto.BulkError, error)
}
