...
type IGroupMembersRepository interface {
	...
	CreateBulkGroupMembers(ctx context.Context, groupMembers []*entity.GroupMember) (int64, []*mongodbErrors.BulkError, error)
	...
	DeleteBulkGroupMembers(ctx context.Context, groupIDs []string) (int64, []*mongodbErrors.BulkError, error)
	DeleteGroupMemberByUserIDAndGroupID(ctx context.Context, userID string, groupID string) error
	DeleteBulkGroupMemberByUserIDAndGroupID(ctx context.Context, userID string, groupIDs []string) (int64, []*mongodbErrors.BulkError, error)
	DeleteBulkGroupMemberByManyUserIDAndGroupID(ctx context.Context, userID []string, groupIDs []string) (int64, []*mongodbErrors.BulkError, error)
}
