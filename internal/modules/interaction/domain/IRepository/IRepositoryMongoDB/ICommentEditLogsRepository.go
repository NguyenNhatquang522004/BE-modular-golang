...
type ICommentEditLogsRepository interface {
	...
	CreateBulkEditLogs(ctx context.Context, editLogs []*entity.CommentEntityEditLog) (int64, []*dto.BulkError, error)
	...
	UpdateBulkEditLogs(ctx context.Context, editLogs []*entity.CommentEntityEditLog) (int64, []*dto.BulkError, error)
	DeleteEditLog(ctx context.Context, editLogID string) error
	DeleteBulkEditLogs(ctx context.Context, editLogsIds []string) (int64, []*dto.BulkError, error)
