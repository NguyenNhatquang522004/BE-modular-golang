...
type ICommentRepository interface {
	...
	CreateBulkComments(ctx context.Context, comments []*entity.Comment) (int64, []*dto.BulkError, error)
	...
	UpdateBulkComments(ctx context.Context, comments []*entity.Comment) (int64, []*dto.BulkError, error)
	DeleteComment(ctx context.Context, commentID string) error
	DeleteBulkComments(ctx context.Context, commentIDs []string) (int64, []*dto.BulkError, error)
