...
type ISavedItemsRepository interface {
	...
	CreateBulkSaveItem(ctx context.Context, saveItems []*entity.UserSavedItem) (int64, []*dto.BulkError, error)
	...
	UpdateBulkSaveItem(ctx context.Context, saveItems []*entity.UserSavedItem) (int64, []*dto.BulkError, error)
	DeleteSaveItem(ctx context.Context, saveItemID string) error
	DeleteBulkSaveItem(ctx context.Context, saveItemIDs []string) (int64, []*dto.BulkError, error)
