...
type ISavedItemsRepository interface {
	...
	GetSaveItemByTargetID(ctx context.Context, userID string, targetID string) (*entity.UserSavedItem, error)
	...
	DeleteSaveItemByUserIDAndTargetID(ctx context.Context, userID string, targetID string) error
