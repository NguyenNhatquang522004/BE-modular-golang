...
func (h *FriendshipDeclined) Execute(req *req.FriendShipUseCaseRequest) (*response.Response, error) {
	// Xử lý logic khi trạng thái là Declined
...
func (h *FriendshipDeclined) Type() enum.StatusFriendship {
