...
func NewBlockChat(blockRepo IRepositoryPostgres.IBlockRepository,
	blockProducer IGraph.IBlockMessage,
	friendshipRepo IRepositoryPostgres.IFriendshipsRepository, friendshipProducer IGraph.IFriendshipMessage,
	followRepo IRepositoryPostgres.IFollowersRepository,
	followProducer IGraph.IFollowMessage) *BlockChat {
	return &BlockChat{
		blockRepo:          blockRepo,
...
func (h *BlockChat) Type() enum.Type_Block {
	return enum.Type_Block_Chat
}
