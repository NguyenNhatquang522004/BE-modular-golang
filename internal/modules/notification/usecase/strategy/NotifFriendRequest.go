...
func NewNotifFriendRequest(notificationRepo IRepositoryCassandra.INotificationsRepository,
	notificationTemplateRepo IRepositoryMongodb.INotificationTemplatesRepository,
	userNotificationSettingsRepo IRepositoryMongodb.IUserNotificationSettingsRepository,
	pool IRepositoryShare.IWorkerPool, socketManager socket.Manager) *NotifFriendRequest {
...
func (r *NotifFriendRequest) Execute(ctx context.Context, req *notificationEvent.NotificationPayload) error {
	...
	for _, userID := range req.SendUser {
		...
		err := r.pool.Run(ctx, func() {
			...
			var entityNotification = &entity.Notification{
				...
				Type:           sharedEnums.NotifFriendRequest,
				ActorID:        ActorID,
...
func (r *NotifFriendRequest) GetType() sharedEnums.NotificationType {
