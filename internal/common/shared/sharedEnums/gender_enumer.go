// Code generated by "enumer -type=Gender -json -transform=snake -trimprefix=Gender"; DO NOT EDIT.
...
const _GenderName = "malefemaleotherhidden"

var _GenderIndex = [...]uint8{0, 4, 10, 15, 21}

const _GenderLowerName = "malefemaleotherhidden"
...
var _GenderValues = []Gender{GenderMale, GenderFemale, GenderOther, GenderHidden}
...
var _GenderNameToValueMap = map[string]Gender{
	...
	_GenderName[10:15]:      GenderOther,
	_GenderLowerName[10:15]: GenderOther,
	_GenderName[15:21]:      GenderHidden,
	_GenderLowerName[15:21]: GenderHidden,
}
