...
Bạn có Neo4j trong stack, đây là "vũ khí bí mật" để làm tính năng "Gợi ý bạn bè" (People You May Know) và Search Ranking.

Graph Model
Nodes: User, Group, Page.
...
Khi User A tìm kiếm từ khóa "Hồng", ElasticSearch trả về 100 kết quả. Làm sao để User B (bạn của A) tên là "Hồng" hiện lên đầu? -> Logic: Query ES lấy list candidate -> Query Neo4j tính khoảng cách xã hội -> Re-rank kết quả.

 Module Cài đặt & Riêng tư (Settings & Privacy) 
